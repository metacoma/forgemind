...
class LifecycleFacts(RuntimeModel):
    """Typed lifecycle facts passed into the policy-backed transition layer.
    ...
    execution_stage_failed: bool = False
    publish_stage_failed: bool = False
    stage_failure_kind: str | None = None
